...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 pb-24 pt-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('admin.articles') }}" class="inline-flex items-center gap-2 text-slate-600 hover:text-slate-700 font-medium">
        ...
        <form action="{{ isset($article) ? route('admin.articles.update', $article->id) : route('admin.articles.store') }}" 
            ...
            <div>
                ...
                <textarea name="content" 
                          ...
                          rows="12"
                          required
                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('content') border-red-500 @enderror">{{ old('content', $article->content) }}</textarea>
                <p class="mt-1 text-sm text-gray-500">You can use Markdown formatting in the content.</p>
                @error('content')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent @error('tags') border-red-500 @enderror"
                           placeholder="e.g., education, study, learning">
